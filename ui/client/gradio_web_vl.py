...
DEFAULT_CKPT_PATH = '/home/zwl/workspace/cciip_vl/model/Qwen-VL-Chat-Int4'
...
def _get_args():
    ...
    parser.add_argument("--server-port", type=int, default=7800,
...
def _launch_demo(args, model, tokenizer):
    ...
    with gr.Blocks() as demo:
        gr.Markdown("""<center><font size=8>CCIIP LAB VL ChatB0T</center>""")

        chatbot = gr.Chatbot(label='CCIIP-VL-Chat', elem_classes="control-height", height=750)
